import os,sys
import numpy as np
from synthetic_data_demo.generate_synthetic_data import *
import utils as ut
import funcs_disp_mist as fdm
from synthetic_data_demo import plot_syn_boundaries as psb
...
def test_synthetic_data():
	...
	psb.plot_boundaries(X, y, x_control, [w_uncons, w_cons], [acc_uncons, acc_cons], [s_attr_to_fp_fn_test_uncons["s1"], s_attr_to_fp_fn_test_cons["s1"]], "syn_cons_dtype_%d_cons_type_%d.png"%(data_type, cons_type) )
	print("\n-----------------------------------------------------------------------------------\n")
